...
- Keep the flat workspace layout declared in `[workspace.metadata.config.layout]`: the root crate is the product package and `xtask/` is the local automation package.
